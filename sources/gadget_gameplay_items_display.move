module tradingcard::gadget_gameplay_items_display {
   ...
   use tradingcard::gadget_gameplay_items_titles::{
    ...
    Bone, Brella, BucketOfWater, CanOpener, Candy, Card, CarMechanicFan, ChopSticks, Clippers,
    ...
    LeftSkate, LightBulb, Lighter, LongShovel, Magnet, MagnetShoes, Mallet, MapOfSouthAfrica,
    ...
    TelescopingLegs, Teeth, Tie, Toothbrush, Toothpaste, TopSecretGadgetPhone, TrickFlower,
